<div class="wrap">
	...
	<p><?php echo sprintf(__('This plugin created by %s from %s and %s gorup', 'wp-sms'), '<a href="http://profiles.wordpress.org/mostafa.s1990/">Mostafa Soufi</a>', '<a href="http://wpbazar.com">WP Bazar</a>', '<a href="http://forum.wp-parsi.com">WP Parsi</a>'); ?>
