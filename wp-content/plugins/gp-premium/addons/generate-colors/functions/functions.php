...
function generate_colors_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Header Colors', 'generate-colors' ),
			'capability' => 'edit_theme_options',
			'priority' => 50,
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Navigation Colors', 'generate-colors' ),
			'capability' => 'edit_theme_options',
			'priority' => 60,
			'panel' => 'generate_colors_panel'
		)
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Sub-Navigation Colors', 'generate-colors' ),
			'capability' => 'edit_theme_options',
			'priority' => 70,
			'panel' => 'generate_colors_panel'
		)
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Content Colors', 'generate-colors' ),
			'capability' => 'edit_theme_options',
			'priority' => 80,
			'panel' => 'generate_colors_panel'
		)
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Sidebar Widget Colors', 'generate-colors' ),
			'capability' => 'edit_theme_options',
			'priority' => 90,
			'panel' => 'generate_colors_panel'
		)
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Footer Widget Colors', 'generate-colors' ),
			'capability' => 'edit_theme_options',
			'priority' => 100,
			'panel' => 'generate_colors_panel'
		)
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Footer Colors', 'generate-colors' ),
			'capability' => 'edit_theme_options',
			'priority' => 110,
			'panel' => 'generate_colors_panel'
		)
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Form Colors', 'generate-colors' ),
			'capability' => 'edit_theme_options',
			'priority' => 130,
			'panel' => 'generate_colors_panel'
		)
