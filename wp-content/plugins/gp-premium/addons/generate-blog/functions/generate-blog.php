...
function generate_blog_scripts() {
	...
	if ( generate_blog_get_masonry() == 'true' ) :
		...
		wp_enqueue_script( 'blog-scripts', plugin_dir_url( __FILE__ ) . 'js/scripts.js', array('jquery-masonry'), GENERATE_BLOG_VERSION, true );
	...
	if ( generate_blog_get_columns() ) :
		wp_enqueue_script( 'blog-matchHeight', plugin_dir_url( __FILE__ ) . 'js/jquery.matchHeight.js', array('jquery'), GENERATE_BLOG_VERSION, true );
	endif;
	
	wp_enqueue_style( 'blog-styles', plugin_dir_url( __FILE__ ) . 'css/style.css' );
...
function generate_blog_post_classes( $classes )
{
	...
	if ( generate_blog_get_masonry() == 'true' ) :
		...
		if ( 'true' == generate_blog_activate_masonry() ) :
