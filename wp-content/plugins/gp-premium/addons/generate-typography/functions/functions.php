...
function generate_fonts_customize_register( $wp_customize ) {
	...
	//require_once dirname(__FILE__) . '/customizer/get-fonts.php';
	require_once dirname(__FILE__) . '/customizer/google-font-dropdown-custom-control.php';
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Body Typography', 'generate-typography' ),
			'capability' => 'edit_theme_options',
			'description' => '',
			'priority' => 30,
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Header Typography', 'generate-typography' ),
			'capability' => 'edit_theme_options',
			'description' => '',
			'priority' => 40,
			'panel' => 'generate_typography_panel'
	...
	$wp_customize->add_control( 
		new Generate_Font_Weight_Custom_Control( 
			$wp_customize, 
			'site_title_font_weight_control', 
			array(
				'label' => __('Font weight','generate-typography'),
				'section' => 'font_header_section',
	...
	$wp_customize->add_control( 
		new Generate_Text_Transform_Custom_Control( 
			$wp_customize, 
			'site_title_font_transform_control', 
			array(
				'label' => __('Text transform','generate-typography'),
				'section' => 'font_header_section',
	...
	$wp_customize->add_control( 
		new Generate_Font_Weight_Custom_Control( 
			$wp_customize, 
			'site_tagline_font_weight_control', 
			array(
				'label' => __('Font weight','generate-typography'),
				'section' => 'font_header_section',
	...
	$wp_customize->add_control( 
		new Generate_Text_Transform_Custom_Control( 
			$wp_customize, 
			'site_tagline_font_transform_control', 
			array(
				'label' => __('Text transform','generate-typography'),
				'section' => 'font_header_section',
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Navigation Typography', 'generate-typography' ),
			'capability' => 'edit_theme_options',
			'description' => '',
			'priority' => 50,
			'panel' => 'generate_typography_panel'
	...
	$wp_customize->add_control( 
		new Generate_Font_Weight_Custom_Control( 
			$wp_customize, 
			'navigation_font_weight_control', 
			array(
				'label' => __('Font weight','generate-typography'),
				'section' => 'font_navigation_section',
	...
	$wp_customize->add_control( 
		new Generate_Text_Transform_Custom_Control( 
			$wp_customize, 
			'navigation_font_transform_control', 
			array(
				'label' => __('Text transform','generate-typography'),
				'section' => 'font_navigation_section',
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Content Typography', 'generate-typography' ),
			'capability' => 'edit_theme_options',
			'description' => '',
			'priority' => 60,
			'panel' => 'generate_typography_panel'
	...
	foreach ( $headings as $heading ) {
		...
		$wp_customize->add_control( 
			new Generate_Text_Transform_Custom_Control( 
				$wp_customize, 
				$heading['transform_slug'] . '_control', 
				array(
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Widget Typography', 'generate-typography' ),
			'capability' => 'edit_theme_options',
			'description' => '',
			'priority' => 60,
			'panel' => 'generate_typography_panel'
	...
	$wp_customize->add_control( 
		new Generate_Font_Weight_Custom_Control( 
			$wp_customize, 
			'widget_title_font_weight_control', 
			array(
				'label' => __('Font weight','generate-typography'),
				'section' => 'font_widget_section',
	...
	$wp_customize->add_control( 
		new Generate_Text_Transform_Custom_Control( 
			$wp_customize, 
			'widget_title_font_transform_control', 
			array(
				'label' => __('Text transform','generate-typography'),
				'section' => 'font_widget_section',
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Footer Typography', 'generate-typography' ),
			'capability' => 'edit_theme_options',
			'description' => '',
			'priority' => 70,
			'panel' => 'generate_typography_panel'
...
function generate_fonts_customize_preview_css() {
	...
	<style>
		...
		#accordion-section-font_section .customize-control-title,
		#accordion-panel-generate_typography_panel .customize-control-title {
			border-top: 1px solid #DDD;
			padding-top: 20px;
			margin-top: 15px;
		}
		
		#accordion-section-font_section li:first-child .customize-control-title,
		#accordion-panel-generate_typography_panel li:first-child .customize-control-title {
			border: 0;
			padding: 0;
			margin: 0;
		}
