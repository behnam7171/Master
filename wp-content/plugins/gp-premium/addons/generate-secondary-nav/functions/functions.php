...
add_action( 'wp_enqueue_scripts','generate_secondary_nav_enqueue_scripts' );
function generate_secondary_nav_enqueue_scripts() {
	
	wp_enqueue_style( 'generate-secondary-nav', plugin_dir_url( __FILE__ ) . 'css/style.css', GENERATE_SECONDARY_NAV_VERSION );
	if ( ! defined( 'GENERATE_DISABLE_MOBILE' ) ) :
		wp_enqueue_script( 'generate-secondary-nav', plugin_dir_url( __FILE__ ) . 'js/navigation.js', array(), GENERATE_SECONDARY_NAV_VERSION, true );
		wp_enqueue_style( 'generate-secondary-nav-mobile', plugin_dir_url( __FILE__ ) . 'css/mobile.css', false, GENERATE_SECONDARY_NAV_VERSION, 'all' );
	endif;
}	
endif;
...
function generate_secondary_nav_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
		...
		array(
			...
			'capability' => 'edit_theme_options',
			'priority' => 50,
			'panel' => 'secondary_navigation_panel'
		)
	);
	...
	$wp_customize->add_control(
		'secondary_nav_mobile_label_control', array(
			'label' => __('Mobile Label', 'generate-secondary-nav'),
	...
	$wp_customize->add_control(
		// ID
		'secondary_nav_position_control',
		// Arguments array
		array(
			'type' => 'select',
	...
	$wp_customize->add_control(
		// ID
		'secondary_nav_alignment_control',
		// Arguments array
		array(
			'type' => 'select',
	...
	if ( class_exists( 'Generate_Spacing_Customize_Misc_Control' ) ) :
		...
		$wp_customize->add_section(
			...
			// Arguments array
			array(
				'title' => __( 'Secondary Navigation Spacing', 'generate-secondary-nav' ),
				'capability' => 'edit_theme_options',
				'priority' => 200,
				'panel' => 'secondary_navigation_panel'
			)
		...
		$wp_customize->add_control(
			new Generate_Spacing_Customize_Misc_Control(
				$wp_customize,
				'generate_secondary_menu_item-heading',
				array(
					'section'  => 'secondary_navigation_spacing_section',
					'label'    => __( 'Secondary Menu Items', 'generate-secondary-nav' ),
					'description' => __( 'These options control the size of your secondary menu items.','generate-secondary-nav' ),
					'type'     => 'spacing-heading',
					'priority' => 146,
					'areas'  => array(
						'left_right'  => __('Left/Right Spacing','generate-secondary-nav'),
						'height' => __('Height','generate-secondary-nav')
					),
				)
			)
		);
		...
		$wp_customize->add_control(
			new Generate_Spacing_Customize_Misc_Control(
				$wp_customize,
				'generate_secondary_submenu-spacing_line-heading',
				array(
					'section'  => 'secondary_navigation_spacing_section',
					'type'     => 'line',
					'priority' => 149,
		...
		$wp_customize->add_control(
			new Generate_Spacing_Customize_Misc_Control(
				$wp_customize,
				'generate_secondary_submenu-spacing-heading',
				array(
					'section'  => 'secondary_navigation_spacing_section',
					'label'    => __( 'Secondary Sub-menu Item Height', 'generate-secondary-nav' ),
					'description' => __( 'The top and bottom spacing of secondary sub-menu items.','generate-secondary-nav' ),
					'type'     => 'spacing-heading',
					'priority' => 150,
				)
			)
	...
	if ( defined( 'GENERATE_COLORS_VERSION' ) ) :
		...
		$wp_customize->add_section(
			...
			// Arguments array
			array(
				'title' => __( 'Secondary Navigation Colors', 'generate-secondary-nav' ),
				'capability' => 'edit_theme_options',
				'priority' => 180,
				'panel' => 'secondary_navigation_panel'
			)
		...
		$wp_customize->add_section(
			...
			// Arguments array
			array(
				'title' => __( 'Secondary Sub-Navigation Colors', 'generate-secondary-nav' ),
				'capability' => 'edit_theme_options',
				'priority' => 190,
				'panel' => 'secondary_navigation_panel'
			)
	...
	if ( defined( 'GENERATE_FONT_VERSION' ) ) :
		...
		$wp_customize->add_section(
			...
			// Arguments array
			array(
				'title' => __( 'Secondary Navigation Typography', 'generate-secondary-nav' ),
				'capability' => 'edit_theme_options',
				'description' => '',
				'priority' => 90,
				'panel' => 'secondary_navigation_panel'
	...
	if ( defined( 'GENERATE_BACKGROUNDS_VERSION' ) && class_exists( 'Generate_Backgrounds_Customize_Misc_Control' ) && class_exists( 'Generate_Background_Upload_Control' ) ) :
		...
		$wp_customize->add_section(
			...
			// Arguments array
			array(
				'title' => __( 'Secondary Background Images', 'generate-secondary-nav' ),
				'capability' => 'edit_theme_options',
				'description' => '',
				'priority' => 500,
				'panel' => 'secondary_navigation_panel'
		...
		$wp_customize->add_control(
			'generate_secondary_backgrounds-nav-repeat',
			array(
				'type' => 'select',
				'section' => 'secondary_bg_images_section',
				'choices' => array(
		...
		$wp_customize->add_control(
			'generate_secondary_backgrounds-nav-item-repeat',
			array(
				'type' => 'select',
				'section' => 'secondary_bg_images_section',
				'choices' => array(
		...
		$wp_customize->add_control(
			'generate_secondary_backgrounds-nav-item-hover-repeat',
			array(
				'type' => 'select',
				'section' => 'secondary_bg_images_section',
				'choices' => array(
		...
		$wp_customize->add_control(
			'generate_secondary_backgrounds-nav-item-current-repeat',
			array(
				'type' => 'select',
				'section' => 'secondary_bg_images_section',
				'choices' => array(
		...
		$wp_customize->add_control(
			'generate_secondary_backgrounds-sub-nav-item-repeat',
			array(
				'type' => 'select',
				'section' => 'secondary_bg_images_section',
				'choices' => array(
		...
		$wp_customize->add_control(
			'generate_secondary_backgrounds-sub-nav-item-hover-repeat',
			array(
				'type' => 'select',
				'section' => 'secondary_bg_images_section',
				'choices' => array(
		...
		$wp_customize->add_control(
			'generate_secondary_backgrounds-sub-nav-item-current-repeat',
			array(
				'type' => 'select',
				'section' => 'secondary_bg_images_section',
				'choices' => array(
...
function generate_secondary_navigation_customize_preview_css() {
	...
	<style>
		...
		#accordion-section-secondary_bg_images_section li {float:left;width:50%;clear:none;}
		#accordion-section-secondary_bg_images_section li.customize-control-backgrounds-heading,
		#accordion-section-secondary_bg_images_section li.customize-control-position,
		#accordion-section-secondary_bg_images_section li.customize-control-line		{display:block;width:100%;clear:both;text-align:center;}
		#accordion-section-secondary_bg_images_section li.customize-control-upload .remove {font-size:10px;}
		#accordion-section-secondary_bg_images_section li.customize-control-position .small-customize-label {display:block;text-align:center;}
		#accordion-section-secondary_bg_images_section .generate-upload .remove {font-size:10px;position:relative;bottom:-5px}
		#accordion-section-secondary_bg_images_section li#customize-control-generate_backgrounds-nav-repeat,
		#accordion-section-secondary_bg_images_section li#customize-control-generate_backgrounds-nav-item-repeat,
		#accordion-section-secondary_bg_images_section li#customize-control-generate_backgrounds-nav-item-hover-repeat,
		#accordion-section-secondary_bg_images_section li#customize-control-generate_backgrounds-nav-item-current-repeat,
		#accordion-section-secondary_bg_images_section li#customize-control-generate_backgrounds-sub-nav-repeat,
		#accordion-section-secondary_bg_images_section li#customize-control-generate_backgrounds-sub-nav-item-repeat,
		#accordion-section-secondary_bg_images_section li#customize-control-generate_backgrounds-sub-nav-item-hover-repeat,
		#accordion-section-secondary_bg_images_section li#customize-control-generate_backgrounds-sub-nav-item-current-repeat {
			float:right;
		}
		
		#customize-control-generate_secondary_backgrounds-nav-repeat,
		#customize-control-generate_secondary_backgrounds-nav-item-repeat,
		#customize-control-generate_secondary_backgrounds-nav-item-hover-repeat,
		#customize-control-generate_secondary_backgrounds-nav-item-current-repeat,
		#customize-control-generate_secondary_backgrounds-sub-nav-item-repeat,
		#customize-control-generate_secondary_backgrounds-sub-nav-item-hover-repeat,
		#customize-control-generate_secondary_backgrounds-sub-nav-item-current-repeat {
			text-align: right;
